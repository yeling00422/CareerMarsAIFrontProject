<template>
  <div class="control-page">
    ...
    <div class="page">
      ...
      <div class="section">
        <div class="sec-title">参赛信息</div>
        <select v-model="form.name" @change="autoSave" class="inp sel">
          <option value="">— 请选择选手 —</option>
          <option>01 南茉</option>
          <option>02 潘虹</option>
          <option>03 李蓓</option>
          <option>04 陆友达</option>
          <option>05 阳智博</option>
          <option>06 徐子媛</option>
          <option>07 柯丽妮</option>
          <option>08 欧书茗 </option>
          <option>09 阮明俊</option>
          <option>10 苏哲</option>
          <option>11 刘芳君</option>
        </select>
...
.total-label { font-size: 30px; letter-spacing: .4em; color: #C084FC; }
