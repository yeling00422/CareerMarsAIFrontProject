...
export default {
  ...
  methods: {
    ...
    loadAnalysisData(){
      ...
      console.log("register-by-phone-code-questions:",this.analysisResultData);
      console.log("register-by-phone-code-userAnswers:",this.interviewScore);
      console.log("register-by-phone-code-expectationPosition:",this.expectationPosition);
      console.log("register-by-phone-code-resume:",this.resume);
    },
    // 补上模板中引用了但没定义的方法
    login() {
      console.log('点击了返回登录'); 
