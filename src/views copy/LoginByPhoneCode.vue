...
export default {
  ...
  methods: {
    loadAnalysisData(){
      ...
      console.log("login-by-phone-code-questions:",this.analysisResultData);
      console.log("login-by-phone-code-userAnswers:",this.interviewScore);
      console.log("login-by-phone-code-expectationPosition:",this.expectationPosition);
      console.log("login-by-phone-code-resume:",this.resume);
    },
    // 补上模板中引用了但没定义的方法
    register() {
      console.log('点击了注册'); 
