...
export default {
  ...
  methods: {
    async loadAnalysisData() {
      ...
      // const resume = this.$route.query.resume;// 将数据转为字符串传递
      // console.log("analysis-load-generateQuestion:",generateQuestion);
      console.log("analysis-load-position:",position);
      console.log("analysis-load-resume:",resume);
      // 设置延迟3秒
      // setTimeout(() => {
      ...
      // }, 3000); // 3000毫秒 = 3秒
        ...
        const API_PATH = "/ai/generate/question";
